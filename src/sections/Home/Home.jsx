              ...
              <div className="flex flex-col items-center md:flex-row md:justify-center lg:justify-start">
                ...
                >
                  <a href="">
                    ...
                    >
                      <a href="https://instagram.com/_ad_vantage?igshid=MzRlODBiNWFlZA==" target="_blank" > <FaInstagram size={20} /></a> 
                    </motion.div>
                  </a> 
                  <a href="">
                    <motion.div
                    ...
                    >
                      <a href="https://wa.me/916205129118" target="_blank" >  <FaWhatsapp size={20} /></a> 
                  ...
                  <a href="">
                    <motion.div
                      ...
                      className="bg-black flex items-center justify-center text-white p-2 rounded-[50%] h-[50px] w-[50px] border-2 border-white -ml-2"
                    >
                     <a href="https://t.me/+NpApuxhZRaRiYzA1" target="_blank" ><FaTelegram size={20} /></a> 
                    </motion.div>
                  </a>
                </motion.div>
              </div>
