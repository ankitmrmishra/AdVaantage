      ...
      <div className="left lg:w-[70%] items-center lg:mr-12 mt-10 lg:mt-0">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:mt-10">
          ...
          >
            <SelectedWork
              title={
               <a href="https://planyortrip.com/" target="_blank"><h3 className="text-[2rem] lg:text-[3.25rem] font-semibold uppercase w-[70%] break-all leading-[3rem]">
          ...
          >
            <SelectedWork
              title={
               <a href="http://www.turkeytravelplanner.com" target="_blank"><h3 className="text-[2rem] lg:text-[3.25rem] font-semibold uppercase w-[70%] break-all leading-[3rem]">
      ...
      <div className="right lg:w-[30%] flex flex-col lg:items-center">
        ...
        >
          <SelectedWork
            rotate={true}
            title={
             <a href="http://www.destamer.com" target="_blank">
