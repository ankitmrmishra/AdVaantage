      ...
      <footer className="pb-[4rem] lg:w-[90%] max-w-[1200px] m-auto px-6 lg:px-10">
        <div className="flex flex-col md:flex-row justify-between mt-[4rem]">
          ...
          >
            ...
            >
              Deep House, Landran, Mohali, 140307, Punjab, India.
            </motion.p>
          ...
          >
            <motion.span variants={riseUpItem}>
              <FooterLink text="Email" handle="Hello@AdVantage.yeah" link="advantage7511@gmail.com"/>
            </motion.span>
            <motion.span variants={riseUpItem}>
              <FooterLink text="Instagram" handle="@AdVantage" link="" />
            </motion.span>
            <motion.span variants={riseUpItem}>
              <FooterLink text="Twitter" handle="@AdVantage" link="" />
            </motion.span>
            <motion.span variants={riseUpItem}>
              <FooterLink text="Medium" handle="@AdVantage" link="" />
            </motion.span>
            <motion.span variants={riseUpItem}>
              <FooterLink text="Telegram" handle="@AdVantage" link="" />
            </motion.span>
            <motion.span variants={riseUpItem}>
              <FooterLink text="LinkedIn" handle="@AdVantage" link="" />
            </motion.span>
            <motion.span variants={riseUpItem}>
              <FooterLink text="Facebook" handle="@AdVantage" link="" />
            </motion.span>
          </motion.div>
        </div>
      </footer>
