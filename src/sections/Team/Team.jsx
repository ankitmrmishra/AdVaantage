      ...
      <div className="flex md:justify-between w-full md:w-[50%] lg:w-[46%]">
        ...
        >
          <motion.img
            variants={tagVariant}
            src={TeamMember1}
            alt="Nitin Mishra, CEO AdVantage"
            className="max-w-[30rem] h-auto mb-3 lg:mb-6 w-[10rem] lg:w-[20rem]"
          />
          <motion.div
          ...
          >
            <p className="text-white md:text-xl lg:text-2xl">Nitin Mishra</p>
        ...
        >
          <motion.img
            variants={tagVariant}
            src={TeamMember2}
            alt="Deboshree Paul, Art Director AdVantage"
            className="max-w-[30rem] h-auto mb-3 lg:mb-6 w-[10rem] lg:w-[20rem]"
          />
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            ...
            className="text-center"
          >
            <p className="text-white md:text-xl lg:text-2xl">Deboshree Paul</p>
            <span className="text-[#929294] text-[80%] lg:text-[100%]">
              Art Director AdVantage
            </span>
          </motion.div>
        </motion.div>
      </div>
      ...
      >
        ...
        <motion.div variants={riseUpItem}>
          <Button className="flex items-center w-fit mt-8 md:mb-0 text-black bg-[#e5e5e5] font-medium">
            <span className="mr-4 ">All AdVenture Team</span> <FiArrowUpRight />
          </Button>
        </motion.div>
      </motion.div>
    </div>
